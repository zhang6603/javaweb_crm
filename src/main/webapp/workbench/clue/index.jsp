	...
	function pageList(pageNo, pageSize) {
		...
		$.ajax({
			...
			data:{
				...
				"clueState":$.trim($("#search-clueState").val()),
				"pageNo":pageNo,
				"pageSize":pageSize
			},
			type:"get",
			...
			success:function (data) {
				/*
					data:
						我们需要拿到的数据:线索列表   [{线索1},{线索2},{线索3},....]
						分页插件需要拿到的数据:总记录条数  total:100

						所以data的格式应该为:{"total":100,"clueList":[{线索1},{线索2},....]}
				 */
				var html = "";
